...
### Wardriving Mode (Phone + Laptop/Pi + ESP32)

For wardriving with phone GPS (iPhone or Android), see the detailed setup instructions:

**[Wardriving Setup Guide](api/WARDRIVING_SETUP.md)**
